...
use crate::{
    ...
    transport::*,
    validator_network::{self, HEALTH_CHECKER_RPC_PROTOCOL},
    ProtocolId,
};
use channel;
...
impl NetworkBuilder {
    ...
    pub fn new(
        ...
        // TODO(abhayb): What should be the channel size?
        // TODO: segment by peer_id?
        ...
        NetworkBuilder {
            ...
            pm_reqs_tx: PeerManagerRequestSender::new(pm_reqs_tx),
            pm_reqs_rx,
    ...
    pub fn add_protocol_handler(
        ...
        let (network_notifs_tx, network_notifs_rx) =
            libra_channel::new(queue_preference, self.channel_size, counter);
    ...
    pub fn add_connection_event_listener(
        ...
        let (tx, rx) = libra_channel::new(QueueStyle::FIFO, self.channel_size, None);
