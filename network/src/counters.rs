...
lazy_static::lazy_static! {
    ...
    pub static ref PENDING_STATE_SYNCHRONIZER_NETWORK_EVENTS: IntCounterVec = register_int_counter_vec!(
        ...
        "Counters(queued,dequeued,dropped) related to pending network notifications to State Synchronizer",
        &["state"]
    ).unwrap();
    ...
    pub static ref PENDING_ADMISSION_CONTROL_NETWORK_EVENTS: IntCounterVec = register_int_counter_vec!(
        ...
        "Counters(queued,dequeued,dropped) related to pending network notifications to Admission Control",
        &["state"]
    ).unwrap();
