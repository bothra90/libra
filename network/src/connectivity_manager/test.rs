...
fn setup_conn_mgr(
    ...
    let (peer_mgr_reqs_tx, peer_mgr_reqs_rx) = libra_channel::new(QueueStyle::FIFO, 1, None);
    let (peer_mgr_notifs_tx, peer_mgr_notifs_rx) = libra_channel::new(QueueStyle::FIFO, 1, None);
